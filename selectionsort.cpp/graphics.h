...
void setcolor(int color)
{
	...
	case 16: PEN = getPen(PS_SOLID, 2, RGB(204, 255, 204)); break;
	}
}
...
void setfontcolor(int color)
{
	...
	case 3: COLOR = (FOREGROUND_RED); break;//do
	...
	case 8: COLOR = (FOREGROUND_GREEN | FOREGROUND_INTENSITY); break;//xanh la
